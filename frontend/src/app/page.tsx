        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/20">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              자연어로 데이터베이스 컬럼을 찾아보세요!<br />
              "매출이 높은 사용자 찾기"와 같은 입력으로 관련 컬럼을 추천받을 수 있습니다.
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-white/80 mb-8">
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">자연어 처리</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">임베딩 기반</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">코사인 유사도</span>
              <span className="bg-white/20 px-4 py-2 rounded-full text-sm">실시간 분석</span>
            </div>
            <Link
              href="/ai"
              className="inline-block bg-white text-purple-600 px-8 py-4 rounded-xl font-semibold hover:bg-purple-50 transition-all duration-200 transform hover:scale-105 shadow-lg"
            >
              🚀 AI 컬럼 추천 시작하기
            </Link>
          </div>
